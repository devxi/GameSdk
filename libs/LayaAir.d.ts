...
declare module laya.display {
	...
	class Node extends laya.events.EventDispatcher  {
		...
		readonly _children: Array<Laya.Sprite>;
...
通过视图数据创建视图。
		 ...
		 * 获取场景根容器
		 */
		static root:laya.display.Sprite;
		 ...
		 * @private 
		 */
		protected static _onSceneLoaded:any;
